  ...
  render() {
    ...
    return(
       <div>
        ...
        >
          <DialogTitle id="alert-dialog-title">Board Game Title</DialogTitle>
          <DialogContent>
          <Card id="libraryBoardGameDetailCardID" className={classes.detailcard} details={this.props.details}>
          <CardActionArea>
              <CardMedia
                className={classes.media}
                image={this.props.details.photo_url}
              ...
              <div className={classes.BoardGameCardTextDiv}>
                ...
                <Typography className={classes.BoardGameCardDescription} variant="body2">{this.props.details.description}</Typography>
              </div>
              </CardActionArea>
              </Card>
          </DialogContent>
          <DialogActions>
            <Button onClick={this.handledetailClose} color="primary">
              Close
            </Button>
            <Button onClick={this.onEditClick} color="primary" autoFocus>
              Edit
            </Button>
          </DialogActions>
        </Dialog>
